<script lang="ts">
    ...
    import ThemeChange from '../../src/components/ThemeChange.svelte';

    import { writable } from 'svelte/store';
    import CLangEditor from '../../src/components/Editors/CLangEditor.svelte';


    let value = '';
    let projectcode = {"code": "print('HelloWorld')", "file_name":"main.c"}
...
<div on:keydown={handleSave} class="flex flex-col h-screen overflow-hidden">
    <div class="sm:block" style="border-bottom:1.2px solid grey">
        <div class="text-sm flex justify-between breadcrumbs px-2">
            <ul>
                ...
                <li>
                    <span style="font-size: small;">You are running our C/C++ editor</span>
                </li>
            </ul>
    ...
    <Splitpanes horizontal={is_small_screen}>
        ...
        <Pane minSize={5} size={60}>
            ...
            <CLangEditor bind:value on:functionEvent={handleFunctionEvent} />
